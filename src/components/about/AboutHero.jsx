...
const Interactive3DVisual = () => {
  ...
  // Continuous animation loop (slow and smooth)
  useEffect(() => {
    const interval = setInterval(() => {
      setTime(prev => prev + 0.005); // Reduced to 0.005 for very slow, smooth motion
    }, 16); // ~60fps
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          opacity: 0.4 + Math.sin(time * 0.2) * 0.08,
          transform: `scale(${1.1 + Math.sin(time * 0.15) * 0.01})`,
        }}
      ></div>
      ...
      <div
        ...
        style={{
          transform: `rotateX(${rotation.x + Math.sin(time) * 1}deg) rotateY(${rotation.y + Math.cos(time * 0.6) * 1}deg) translateZ(0)`,
        }}
      >
        {/* Floating Elements */}
        <div className="absolute inset-0">
          ...
          <div 
            ...
            style={{
              transform: `translate(${Math.sin(time * 0.3) * 2}px, ${Math.cos(time * 0.4) * 1.5}px) rotate(${time * 5}deg) scale(${1 + Math.sin(time * 0.5) * 0.02})`,
            }}
          >
          ...
          <div 
            ...
            style={{
              transform: `translate(${Math.cos(time * 0.45) * 2.5}px, ${Math.sin(time * 0.35) * 2}px) rotate(${-time * 6}deg) scale(${1 + Math.cos(time * 0.6) * 0.03})`,
            }}
          >
          ...
          <div 
            ...
            style={{
              transform: `translate(${Math.sin(time * 0.4) * 3}px, ${Math.cos(time * 0.35) * 2.5}px) rotate(${time * 7.5}deg) scale(${1 + Math.sin(time * 0.75) * 0.03})`,
            }}
          >
          ...
          <div 
            ...
            style={{
              transform: `translate(${Math.cos(time * 0.5) * 2}px, ${Math.sin(time * 0.4) * 1.5}px) rotate(${-time * 8.5}deg) scale(${1 + Math.cos(time * 0.7) * 0.025})`,
            }}
          >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div 
            ...
            style={{
              transform: `scale(${1 + Math.sin(time * 0.3) * 0.01})`,
            }}
          >
            ...
            <div 
              ...
              style={{
                ...
                opacity: 0.6 + Math.sin(time * 0.3) * 0.05,
              }}
            ></div>
            <div 
              ...
              style={{
                transform: `scale(${1 + Math.cos(time * 0.5) * 0.02})`,
                opacity: 0.7 + Math.cos(time * 0.4) * 0.03,
              }}
            ></div>
            <div 
              ...
              style={{
                transform: `scale(${1 + Math.sin(time * 0.6) * 0.015})`,
                opacity: 0.8 + Math.sin(time * 0.5) * 0.025,
              }}
            ></div>
            ...
            <div 
              ...
              style={{
                transform: `rotate(${time * 7}deg) scale(${1 + Math.sin(time * 0.6) * 0.008})`,
              }}
            >
              <div 
            ...
            <div 
              ...
              style={{
                transform: `translate(-50%, -50%) rotate(${time * 12}deg) translateY(-120px)`,
              }}
            ></div>
            <div 
            ...
            <div 
              ...
              style={{
                transform: `translate(-50%, -50%) rotate(${time * 12}deg) translateX(-120px)`,
              }}
            ></div>
            <div 
        ...
        <div className="absolute inset-0 pointer-events-none">
          <svg className="w-full h-full" viewBox="0 0 400 400">
            ...
            <path
              ...
              fill="none"
              style={{
                opacity: 0.3 + Math.sin(time * 0.3) * 0.1,
              }}
            />
            <path
              ...
              fill="none"
              style={{
                opacity: 0.3 + Math.sin(time * 0.3 + 0.2) * 0.1,
              }}
            />
            <path
              ...
              fill="none"
              style={{
                opacity: 0.3 + Math.sin(time * 0.3 + 0.4) * 0.1,
              }}
            />
            <path
              ...
              fill="none"
              style={{
                opacity: 0.3 + Math.sin(time * 0.3 + 0.6) * 0.1,
              }}
            />
          </svg>
        </div>
